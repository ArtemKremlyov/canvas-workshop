...
// Основные настройки:
$recipients = ['gfvhhhggffghh@gmail.com']; // Получатели писем
$subject = $_SERVER['SERVER_NAME'] . ' — Новая заявка'; // Тема письма

$before_table = '<h2 style="color:#222">'. $subject .'</h2><p style="color:#222">Данные отправителя:</p>'; // HTML-содержимое до таблицы
